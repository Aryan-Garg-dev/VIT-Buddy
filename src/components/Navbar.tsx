...
export const Navbar = ({ transparent = false }: { transparent?: boolean })=>{
  ...
  return (
    <div className={cn("z-50 bg-background fixed top-0 w-full flex items-center justify-between px-5 py-2 font-fancy select-none text-4xl", scrolled && "border-b shadow-sm", !transparent && "bg-primary-foreground")}>
